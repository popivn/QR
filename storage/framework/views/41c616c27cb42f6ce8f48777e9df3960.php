...
<?php $__env->startSection('title', 'Chờ Phân Công - FesSuport - VTTU'); ?>
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mobile-space-y-4">
        <div>
            ...
            <p class="text-gray-600 mt-1 mobile-text-sm">
                Xin chào, <span class="font-semibold text-blue-600"><?php echo e($user->name); ?></span>
            </p>
        </div>
            ...
            <div class="bg-gray-50 rounded-lg p-4 md:p-6 mb-6">
                ...
                <div class="grid mobile-grid md:grid-cols-2 gap-4 text-left">
                    <div class="bg-white rounded-lg p-3">
                        ...
                        <p class="text-gray-900 font-semibold mobile-text-sm"><?php echo e($user->name); ?></p>
                    </div>
                    <div class="bg-white rounded-lg p-3">
                        <label class="block text-sm font-medium text-gray-600">Email:</label>
                        <p class="text-gray-900 font-semibold mobile-text-sm break-all"><?php echo e($user->email); ?></p>
                    </div>
                    <div class="bg-white rounded-lg p-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Workspace\Laravel\VTTU\QRScan\resources\views/group/waiting.blade.php ENDPATH**/ ?>