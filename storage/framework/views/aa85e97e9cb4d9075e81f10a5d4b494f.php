        ...
        <div class="stats-card rounded-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e($leaderboard->count()); ?></p>
                </div>
        ...
        <div class="stats-card success rounded-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e(number_format($totalSystemScans)); ?></p>
                </div>
                <div class="text-4xl opacity-80">
        ...
        <div class="stats-card warning rounded-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e(number_format($totalSystemStudents)); ?></p>
                </div>
                <div class="text-4xl opacity-80">
            ...
            <?php if($leaderboard->count() > 0): ?>
                <div class="space-y-4">
                    <?php $__currentLoopData = $leaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="group-card rank-<?php echo e($rank <= 3 ? $rank : 'other'); ?> bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <?php if($group->description): ?>
                                            <p class="text-sm text-gray-600 mb-2"><?php echo e($group->description); ?></p>
                                        <?php endif; ?>
                                        ...
                                        <div class="space-y-2">
                                            <div>
                                                <div class="flex justify-between text-sm mb-1">
                                                    ...
                                                    <span class="font-semibold text-blue-600"><?php echo e(number_format($group->total_scans)); ?></span>
                                                </div>
                                                <div class="w-full bg-gray-200 rounded-full h-2">
                                                    <div class="progress-bar h-2 rounded-full" style="width: <?php echo e($scanPercentage); ?>%"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div class="flex justify-between text-sm mb-1">
                                                    ...
                                                    <span class="font-semibold text-green-600"><?php echo e(number_format($group->unique_students)); ?></span>
                                                </div>
                                                <div class="w-full bg-gray-200 rounded-full h-2">
                                                    <div class="bg-gradient-to-r from-green-500 to-green-600 h-2 rounded-full" style="width: <?php echo e($studentPercentage); ?>%"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="text-right">
                                    <div class="grid grid-cols-2 gap-4 text-center">
                                        <div class="bg-blue-50 rounded-lg p-3">
                                            <div class="text-2xl font-bold text-blue-600"><?php echo e(number_format($group->total_scans)); ?></div>
                                            <div class="text-xs text-gray-600">Lần quét</div>
                                        </div>
                                        <div class="bg-green-50 rounded-lg p-3">
                                            <div class="text-2xl font-bold text-green-600"><?php echo e(number_format($group->unique_students)); ?></div>
                                    ...
                                    <div class="mt-3 flex space-x-2">
                                        <a href="<?php echo e(route('qr.statistics', $group->id)); ?>" 
...
document.addEventListener('DOMContentLoaded', function() {
    <?php if($leaderboard->count() > 0): ?>
        ...
        const scanData = <?php echo json_encode($leaderboard->pluck('total_scans'), 15, 512) ?>;
