        ...
        <div class="bg-white rounded-xl shadow-sm p-4 lg:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3 lg:ml-4 min-w-0 flex-1">
                    ...
                    <p class="text-xl lg:text-2xl font-semibold text-gray-900"><?php echo e($totalScans); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-4 lg:p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3 lg:ml-4 min-w-0 flex-1">
                    ...
                    <p class="text-xl lg:text-2xl font-semibold text-gray-900"><?php echo e($uniqueStudents); ?></p>
                </div>
            </div>
        </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $statistics->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between p-2 lg:p-3 bg-gray-50 rounded-lg">
                        <div class="min-w-0 flex-1">
                            <div class="font-medium text-gray-800 text-sm lg:text-base truncate"><?php echo e($stat->student->name ?? 'N/A'); ?></div>
                            <div class="text-xs lg:text-sm text-gray-600">MSSV: <?php echo e($stat->student->mssv); ?></div>
                        </div>
                        <div class="text-right flex-shrink-0 ml-2">
                            <div class="text-xs lg:text-sm font-semibold text-blue-600"><?php echo e($stat->scan_count); ?> lần</div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $statistics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    <div class="flex items-start justify-between mb-3">
                        <div class="flex items-center min-w-0 flex-1">
                            ...
                            <div class="ml-3 min-w-0 flex-1">
                                ...
                                <div class="text-xs text-gray-600">MSSV: <?php echo e($stat->student->mssv); ?></div>
                            </div>
                        </div>
                    ...
                    <div class="flex justify-between items-center text-xs text-gray-600">
                        <span>Lớp: <?php echo e($stat->student->class ?? 'N/A'); ?></span>
                        <span><?php echo e($stat->last_scanned_at->format('d/m H:i')); ?></span>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
