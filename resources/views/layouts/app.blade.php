        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    @auth
                        <a href="{{ route('group.index') }}" class="text-gray-700 hover:text-blue-600 smooth-transition">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="text-gray-700 hover:text-blue-600 smooth-transition">
                            <i class="fas fa-sign-in-alt mr-1"></i>Đăng nhập
                        </a>
                        <a href="{{ route('register') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg smooth-transition">
            ...
            <div id="mobile-menu" class="hidden md:hidden border-t border-gray-200 py-4">
                <div class="flex flex-col space-y-2">
                    @auth
                        <a href="{{ route('group.index') }}" class="text-gray-700 hover:text-blue-600 py-2 smooth-transition">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="text-gray-700 hover:text-blue-600 py-2 smooth-transition">
                            <i class="fas fa-sign-in-alt mr-2"></i>Đăng nhập
                        </a>
                        <a href="{{ route('register') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg smooth-transition text-center">
    ...
    <footer class="bg-white border-t border-gray-200 mt-12">
        <div class="container mx-auto px-4 py-6">
            <div class="text-center text-gray-600 mobile-text-sm">
                <p>&copy; {{ date('Y') }} QR Scan System - VTTU. Tất cả quyền được bảo lưu.</p>
            </div>
        </div>
    </footer>
