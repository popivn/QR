...
<body class="bg-gray-100 min-h-screen">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-4">
                    <a href="{{ route('qr.list') }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg transition duration-200">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <form action="{{ route('qr.upload') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
